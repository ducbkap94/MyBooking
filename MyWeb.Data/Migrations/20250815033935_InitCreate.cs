        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityMaintenance = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CashBookId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    AdvertisingCostId = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashBooks", x => x.CashBookId);
                    table.ForeignKey(
                        name: "FK_CashBooks_Maintenances_MaintenanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdvertisingCostId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    Description = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CashBookId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisingCosts", x => x.AdvertisingCostId);
                    table.ForeignKey(
                        name: "FK_AdvertisingCosts_CashBooks_CashBookId",
                        column: x => x.CashBookId,
                        principalTable: "CashBooks",
                        principalColumn: "CashBookId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_CashBooks_CashBookId",
                        column: x => x.CashBookId,
                        principalTable: "CashBooks",
                        principalColumn: "CashBookId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisingCosts_CashBookId",
                table: "AdvertisingCosts",
                column: "CashBookId",
                unique: true,
                filter: "[CashBookId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashBooks_MaintenanceId",
                table: "CashBooks",
